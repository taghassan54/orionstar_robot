...
class RobotSmileState extends StatelessWidget {
   RobotSmileState({super.key,}) {
    ...
    controllerLogic.videoPath=Assets.videosMiniEmoSmile;
  ...
  Widget build(BuildContext context) {
    return RobotPlayVideoState(videoController: Get.find<VideoControllerLogic>().videoPlayerController, videoPath: Assets.videosMiniEmoSmile, robotVideoType: Get.find<VideoControllerLogic>().robotVideoType);
