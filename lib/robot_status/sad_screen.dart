...
class RobotSadState extends StatelessWidget {
   RobotSadState({Key? key}) {
    ...
    controllerLogic.videoPath=Assets.videosSadVideo;
  ...
  Widget build(BuildContext context) {
    return RobotPlayVideoState(videoController: Get.find<VideoControllerLogic>().videoPlayerController, videoPath: Assets.videosSadVideo, robotVideoType: Get.find<VideoControllerLogic>().robotVideoType);
